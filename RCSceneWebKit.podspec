#
# Be sure to run `pod lib lint RCSceneWebKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'RCSceneWebKit'
  s.version          = '0.1.1'
  s.summary          = 'RCSceneWebKit of RongCloud Scene.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
			RongCloud RCSceneWebKit SDK for iOS.
                       DESC
  ...
  s.source           = { :git => 'https://github.com/rongcloud-community/rongcloud-scene-web-kit-ios.git', :tag => s.version.to_s }
